...
var AddLayerButton = React.createClass({displayName: "AddLayerButton",
  render: function() {
    ...
    return (
      React.createElement("div", {className: "add-layer", style: style, onClick: this.props.addLayer}, "+")
    )
  }
})

var AddLayers = React.createClass({displayName: "AddLayers",
  render: function() {
    return (
      React.createElement("div", {className: "add-layers"}, 
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "app"}, 
        React.createElement(AddLayers, {ref: "addlayers", addLayer: this.addLayer}), 
        React.createElement(LayerList, {ref: "layerlist", layers: this.state.layers}), 
        React.createElement(WorkSpace, {width: workSpaceWidth, layers: this.state.layers, ref: "workspace"})
      )
    )
  }
})
...
module.exports = App
},{"./AddLayers.jsx":157,"./LayerList.jsx":159,"./WorkSpace.jsx":160,"./hexagon.js":161,"react":156}],159:[function(require,module,exports){
var React = require('react')

var Layer = React.createClass({displayName: "Layer",
  render: function() {
    return (
      React.createElement("div", {className: "layer"}, this.props.layer.name)
    )
  }
})
...
var LayerList = React.createClass({displayName: "LayerList",
  render: function() {
    var layers = this.props.layers.map(function(layer, idx) {
      return (React.createElement(Layer, {layer: layer, key: idx}))
    })
    return (
      React.createElement("div", {className: "layer-list"}, 
      layers
      )
    )
  }
